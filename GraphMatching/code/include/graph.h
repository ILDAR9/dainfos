...
protected:
    ...
    */
    ...
    typedef std::list<Match>::iterator seed_iterator;
...
public:
    ...
    */
     ...
     */
    void showInterResults(std::set<Match, CompareMatches> & matches, Graph & g);
    /**
    ...
    */
	...
	std::set<Match, CompareMatches> pgm(Graph & g, std::list< Match> & seed,int r, bool flag);
    /*
    ...
    /*
    * super vertex and banced top selection
    */
    std::set<Match, CompareMatches> expandTopStack(Graph & g, std::list< Match> & seed,int r, int push_level, int push_size);
    /*
     * Spreads seed first then in every iteration randomly choose matched unused pair for percolation
     */
    std::set<Match, CompareMatches> noisySeeds(Graph & g, std::list< Match> & seed,int r);
    /*
     * Generates noisy seed set for noisySeeds
     */
    std::set<Match, CompareMatches> expandOnce(Graph & g, std::list< Match> & seed,int r, int seed_max_count);
